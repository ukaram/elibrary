...
* The original package name 'edu.mu.cs.cs425.demowebapps.elibrary.elibrary-1' is invalid and this project uses 'edu.mu.cs.cs425.demowebapps.elibrary.elibrary1' instead.
